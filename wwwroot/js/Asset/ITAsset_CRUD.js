...
var AddEdit = function (id) {
    var url = "/Asset/ITAddEdit?id=" + id;
    if (id > 0) {
        $('#titleExtraBigModal').html("Edit IT Asset");
    }
    else {
        $('#titleExtraBigModal').html("Add IT Asset");
    }
    loadExtraBigModal(url);
};
...
var PreparedFormObj2 = function () {
    ...
    _FormData.append('LocationArea', $("#LocationArea").val())
    _FormData.append('Area', $("#Area").val())
    _FormData.append('SubArea', $("#SubArea").val())
    ...
    _FormData.append('MISAssetNo', $("#MISAssetNo").val())
    _FormData.append('OSDetails', $("#OSDetails").val())
    _FormData.append('processor_model', $("#processor_model").val())
    _FormData.append('desk_details', $("#desk_details").val())
    _FormData.append('ram_details', $("#ram_details").val())
    _FormData.append('serial_number', $("#serial_number").val())
