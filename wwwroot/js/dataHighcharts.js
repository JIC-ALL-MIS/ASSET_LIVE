...
$(document).ready(function () {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            //createPIECharts2(weeklydata, titleMessage, totalspent.toFixed(0));

            //createPIECharts3(weeklydata, titleMessage, totalspent.toFixed(0));
        }
    })
...
function createPIECharts2(sum, titleText, totalspent) {
...
function createPIECharts3(sum, titleText, totalspent) {
